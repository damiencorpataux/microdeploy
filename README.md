...
`TODO: Full example with caching.`

Automation of deploy and run tests for this project:

Asciinema version:
[![asciicast](https://asciinema.org/a/8Kf8dDjlg7aSeQ1PJnKJ97pVZ.png)](https://asciinema.org/a/8Kf8dDjlg7aSeQ1PJnKJ97pVZ?autoplay=1)

Text-ony version:
```sh
python -m deploy package put tests
```
```
Uploading to MCU: 8 files from package: tests...
Put: tests/test_pinout_pinwrap.py -> tests/test_pinout_pinwrap.py... 9747 bytes
     100%, 7.1s, 10939 bits/s, 0 bytes left, 0.0s left.    
done.
Put: tests/test_pinout_pinout.py -> tests/test_pinout_pinout.py... 4059 bytes
     100%, 3.5s, 9361 bits/s, 0 bytes left, 0.0s left.     
done.
Put: tests/__init__.py -> tests/__init__.py... 502 bytes
     100%, 1.2s, 3216 bits/s, 0 bytes left, 0.0s left.   
done.
Put: tests/lib-micropython/unittest.py -> tests/lib-micropython/unittest.py... 7193 bytes
     100%, 5.5s, 10522 bits/s, 0 bytes left, 0.0s left.    
done.
Put: tests-run.py -> main.py... 373 bytes
     100%, 1.2s, 2576 bits/s, 0 bytes left, 0.0s left.   
done.
Put: pinout/__init__.py -> pinout/__init__.py... 6468 bytes
     100%, 5.0s, 10291 bits/s, 0 bytes left, 0.0s left.    
done.
Put: pinout/watcher.py -> pinout/watcher.py... 2235 bytes
     100%, 2.3s, 7680 bits/s, 0 bytes left, 0.0s left.     
done.
Put: pinout/pinwrap.py -> pinout/pinwrap.py... 6147 bytes
